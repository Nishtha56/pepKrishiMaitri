            ...
            >
                <div className="container mx-auto flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-base font-black tracking-tight uppercase">{t('terms.title')}</h1>
                            <p className="text-[11px] text-emerald-400/80 font-medium">{t('terms.subtitle')}</p>
                        </div>
                    </div>
                    <motion.div 
                ...
                >
                    ...
                    <div className="text-center mb-12">
                        <h2 className="text-4xl md:text-6xl font-black text-white mb-4 uppercase tracking-tighter">
                            {t('terms.termsOf')} <span className="bg-gradient-to-r from-emerald-400 to-green-400 bg-clip-text text-transparent">{t('terms.service')}</span>
                        </h2>
                    ...
                    <div className="space-y-6">
                        ...
                        >
                            <h2 className="text-2xl font-black text-white mb-4 uppercase tracking-tight">
                                <span className="text-emerald-400">1.</span> {t('terms.acceptance')}
                            </h2>
                        ...
                        >
                            <h2 className="text-2xl font-black text-white mb-4 uppercase tracking-tight">
                                <span className="text-emerald-400">2.</span> {t('terms.userResponsibilities')}
                            </h2>
                            <p className="text-zinc-400 leading-relaxed">
                        ...
                        >
                            <h2 className="text-2xl font-black text-white mb-4 uppercase tracking-tight">
                                <span className="text-emerald-400">3.</span> {t('terms.prohibitedConduct')}
                            </h2>
                            <p className="text-zinc-400 leading-relaxed">
                                {t('terms.prohibitedConductDesc')}
                            </p>
                        </motion.div>
                        ...
                        >
                            <h2 className="text-2xl font-black text-white mb-4 uppercase tracking-tight">
                                <span className="text-emerald-400">4.</span> {t('terms.limitationLiability')}
                            </h2>
                            <p className="text-zinc-400 leading-relaxed">
                                {t('terms.limitationLiabilityDesc')}
                            </p>
                        </motion.div>
                    </div>
